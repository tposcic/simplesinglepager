...
! function(e, t) {
    ...
    i.animateScroll = function(n, o, c) {
        var i = y(o ? o.getAttribute("data-options") : null),
            u = d(t || s, c || {}, i),
            f = "[object Number]" === Object.prototype.toString.call(n) ? !0 : !1,
            h = f || !n.tagName ? null : n;
        if (f || h) {
            var m = e.pageYOffset;
            u.selectorHeader && !r && (r = document.querySelector(u.selectorHeader)), a || (a = S(r));
            var b, E, I = f ? n : g(h, a, parseInt(u.offset, 10)),
                ...
                C = function(t, r, a) {
                    var c = e.pageYOffset;
                    (t == r || c == r || e.innerHeight + c >= A) && (clearInterval(a), O(n, r, f), u.callback(n, o))
                },
                M = function() {
        ...
        I = function(r) {
            if (0 === r.button && !r.metaKey && !r.ctrlKey && (o = h(r.target, t.selector), o && "a" === o.tagName.toLowerCase() && o.hostname === e.location.hostname && o.pathname === e.location.pathname && /#/.test(o.href))) {
                ...
                if ("#" === a) {
                    ...
                    return n.setAttribute("data-scroll-id", l), n.id = "", void(e.location.hash.substring(1) === l ? E() : e.location.hash = l)
                }
    ...
    return i.destroy = function() {
        ...
        u && (i.destroy(), t = d(s, n || {}), r = t.selectorHeader ? document.querySelector(t.selectorHeader) : null, a = S(r), document.addEventListener("click", I, !1), e.addEventListener("hashchange", E, !1), r && e.addEventListener("resize", H, !1))
    }, i
}), smoothScroll.init();